...
int main()
{
    ...
    printf("\nPress 13 For Finding The Nth Number Of  Fibonacci Series.");
    printf("\nPress 14 For Finding Prime Number.");
    printf("\nPress 15 For Finding Prime Number Series.");
    printf("\nPress 16 For Finding And Adding Prime Number Series.");
    printf("\nPress 17 For Finding The Largest Number.");
    printf("\nPress 18 For Finding The Lower Number.");
    ...
    scanf("%f", &Num2);
        Result = Num1 * Num2;
        printf("Multiplication Of Two Number Is : %.2f", Result);
        break;
    ...
    scanf("%f", &Num2);
        Result = Num1 / Num2;
        printf("Divide Of Two Number Is : %.2f", Result);
        break;
    ...
    printf("Enter The Power Of Second Number : ");
        ...
        printf("Square Of Addition Two Number Is : %.2f", Result);
        break;
    ...
    scanf("%d", &R2);
        R3 = R2%R1;
        printf("Modula Of Two Number Is : %d", R3);
        break;
    case 7:printf("Enter The Integrate Number Please : ");
    scanf("%d",&a);
        for( ;a!=0; )
        {
            re = a % 10;
    ...
    printf("The Value Of X Is : %.2f\nThe Power N Is : %d\nThe Result Is : %.2f",x,n,r);
        break;
    case 9: printf("Enter The Number Of Nth Series Please : ");
    scanf("%d", &n);
        for( i=1;i<=n;i++)
        {
            s = i*i;
        }
        printf("The Result Of %d th Series Is : %d",n,s);
        break;
    ...
    if( year % 4 == 0 )
    {
        ...
        break;
    case 13: printf("\nEnter The Integrate Number Please : ");
    scanf("%d", &n);
        for( i=1;i<=n;i++ )
        {
            if( i ==0 || i == 1 )
    ...
    printf("Enter The Second Number Please : ");
    scanf("%d", &b);
    printf("Enter The Threed Number Please : ");
    scanf("%d", &c);
        if( a>b )
        {
            if( a>c )
    ...
    scanf("%f",&salary);
        ...
        printf("The Salary Of Odd Number  : %.2f",T_salary);
        Emp++;
        if( Emp<=n)
            goto start;
        else
    ...
    scanf("%f", &salary);
        bonus = salary*50/100;
        T_salary = bonus + salary;
        printf("The Salary Of Even Number e : %.2f",T_salary);
        Emp++;
        if( Emp<=n)
            goto start;
        else
